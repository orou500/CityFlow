...
export const ACHIEVEMENT_DEFINITIONS = [
  ...
  },
  {
    id: 'wrecker_ach',
    name: 'Wrecker',
    description: 'Demolish your first building',
    category: 'development',
    points: 20,
    icon: '🏗️',
    condition: { type: 'demolitions_completed', target: 1 },
  },
  {
    id: 'urban_renewal',
    name: 'Urban Renewal',
    description: 'Demolish 5 buildings',
    category: 'development',
    points: 40,
    icon: '🏚️',
    condition: { type: 'demolitions_completed', target: 5 },
  },
  {
    id: 'redeveloper_1',
    name: 'Rebuilder',
    description: 'Redevelop a cleared plot for the first time',
    category: 'development',
    points: 30,
    icon: '🔨',
    condition: { type: 'redevelopments_completed', target: 1 },
  },
  {
    id: 'redeveloper_10',
    name: 'Architect of Renewal',
    description: 'Complete 10 redevelopments',
    category: 'development',
    points: 100,
    icon: '🏙️',
    condition: { type: 'redevelopments_completed', target: 10 },
    rewardBadge: 'renewal_architect',
  },
  {
    id: 'redeveloper_50',
    name: 'Urban Planner',
    description: 'Complete 50 redevelopments',
    category: 'development',
    points: 300,
    icon: '🌇',
    condition: { type: 'redevelopments_completed', target: 50 },
    rewardBadge: 'urban_planner',
    rewardTitle: 'Urban Planner',
    hidden: true,
  },
