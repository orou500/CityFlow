...
import { ensureCityDistricts } from './citySeeding.js';
...
export async function resetWorld() {
  ...
  const districtsCreated = await ensureCityDistricts(cities);
  console.log(`[SEASON] Created ${districtsCreated.length} districts`);
