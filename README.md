...
│       ├── engine/          # Simulation logic (tick, market, season reset, property generation, valuation, credit score, company processing, city contracts, treasury investments, property risk)
