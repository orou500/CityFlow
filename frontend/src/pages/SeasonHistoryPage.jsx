    ...
    <div className="h-full overflow-y-auto bg-white dark:bg-gray-900 p-4 md:p-6 max-w-5xl mx-auto">
      ...
      {data?.activeSeason && (
        <div className="mb-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <h2 className="text-lg font-semibold text-blue-800 dark:text-blue-300 mb-2">{t('seasons.activeSeason')}</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <StatCard
              label={t('seasons.seasonNumber', { number: data.activeSeason.number })}
              value={data.activeSeason.name || `#${data.activeSeason.number}`}
            />
