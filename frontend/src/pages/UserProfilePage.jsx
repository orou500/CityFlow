...
export default function UserProfilePage() {
  ...
  async function handleUnlinkOAuth() {
    if (!confirm('Are you sure you want to unlink your OAuth provider?')) return;
    try {
      ...
      if (data.error) setMsg(data.error);
        ...
        setOauthStatus((prev) => ({ ...prev, oauth: { provider: null, linked: false } }));
        setMsg('OAuth provider unlinked');
      }
    } catch {
            ...
            <div className="mt-6 border-t border-gray-200 dark:border-gray-700 pt-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between bg-gray-50 dark:bg-gray-800 rounded-lg px-4 py-3">
                  ...
                  {oauthStatus.oauth.linked && oauthStatus.oauth.provider === 'google' ? (
                    <div className="flex items-center gap-2">
